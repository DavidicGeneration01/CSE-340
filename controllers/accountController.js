...
function buildLogin(req, res) {
    res.render("account/login", {
        ...
        account_email: req.body?.account_email || ""  // <-- pass email to template
    });
}
...
async function accountManagement(req, res, next) {
  try {
    ...
    res.render("account/accountManagement", { title: "Account Management", nav, errors: null, accountData: res.locals.accountData });
  } catch (error) {
    next(error);
  }
}
...
async function updateAccount(req, res, next) {
  try {
    ...
    if (accountResult) {
      ...
      return res.status(501).render("account/update-account", { title: "Edit Account", nav, errors: null, ...req.body });
    }
  } catch (error) {
...
async function updatePassword(req, res, next) {
  ...
  try {
    ...
    return res.status(500).render("account/update-account", { title: "Edit Account", nav, errors: null, account_id });
  }
  ...
  if (passwordResult) {
    ...
    return res.status(501).render("account/update-account", { title: "Edit Account", nav, errors: null, account_id });
  }
}
